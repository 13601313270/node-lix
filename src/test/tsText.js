...
[
    ...
    ['{label?:any}', '{"type":"object","value":[{"type":"objectValue","mastNeed":false,"key":"label","value":{"type":"any"}}]}'],
    ['{label:string}[]', '{"type":"array","value":{"type":"object","value":[{"type":"objectValue","mastNeed":true,"key":"label","value":{"type":"string"}}]}}'],
].forEach(vals => {
    if (JSON.stringify(tsCheck(vals[0])) === vals[1]) {
        console.log(JSON.stringify(tsCheck(vals[0])) === vals[1])
    } else {
        console.log(false, vals[0], JSON.stringify(tsCheck(vals[0])), vals[1])
    }
})
